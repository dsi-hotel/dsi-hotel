...
export const metadata: Metadata = {
  ...
  description:
    'Infogérance IT spécialisée hôtellerie de luxe en Europe. Infrastructure, cybersécurité, Wi-Fi, PCI-DSS. Astreinte 24/7, SLA garanti.',
  keywords: [
    'infogérance hôtel',
    'MSP IT Paris',
  ...
  openGraph: {
    ...
    siteName: 'DSI Hotel',
    title: 'DSI Hotel — MSP IT Hôtellerie de Luxe Europe',
    description:
      'Infogérance IT spécialisée hôtellerie de luxe en Europe. Infrastructure, cybersécurité, Wi-Fi, PCI-DSS. Astreinte 24/7, SLA garanti.',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'DSI Hotel — MSP IT Hôtellerie de Luxe',
      },
    ],
  },
  twitter: {
    ...
    title: 'DSI Hotel — MSP IT Hôtellerie de Luxe Europe',
    description: 'Infogérance IT spécialisée hôtellerie de luxe en Europe.',
  },
}
