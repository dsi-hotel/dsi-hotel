...
export const es: typeof fr = {
  ...
  hero: {
    eyebrow: 'MSP IT · Hotelería de Lujo',
    title1: 'La IT ',
    title2: 'invisible.',
  ...
  services: {
    ...
    desc: 'Cada servicio está diseñado en torno a las limitaciones operacionales propias de la hotelería de lujo.',
  ...
  whyUs: {
    ...
    h2b: 'la hotelería de lujo',
    desc: 'Nuestra especialización exclusiva en hotelería de lujo nos permite anticipar sus necesidades antes de que se conviertan en problemas. Cada solución está calibrada para las exigencias de un establecimiento de 4 o 5 estrellas.',
