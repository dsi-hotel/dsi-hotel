...
export const en: typeof fr = {
  ...
  services: {
    ...
    h2b: 'for hospitality',
    desc: 'Each service is designed around the operational constraints of hospitality.',
  ...
  whyUs: {
    ...
    h2a: 'IT designed for',
    h2b: 'hospitality',
    desc: 'Our exclusive specialization in hospitality allows us to anticipate your needs before they become problems. Each solution is calibrated for the demands of a 4 or 5-star establishment.',
  ...
  projects: {
    ...
    confidential: 'Project shared with client consent · Other references available under NDA',
    card: {
      country: 'Geneva, Switzerland',
      hotel: 'Hôtel Métropole Genève',
      stars: 'Palace · 5-star Superior · Left bank, Lake Geneva',
      tags: ['IT Opening', 'Full Infrastructure', 'Oracle OPERA PMS', 'Wi-Fi 7', 'Cybersecurity'],
      kpis: [
