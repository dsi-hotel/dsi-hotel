export const fr = {
  ...
  services: {
    ...
    desc: "Chaque service est conçu autour des contraintes opérationnelles propres à l'hôtellerie.",
  ...
  whyUs: {
    ...
    h2a: "L'IT pensé pour",
    h2b: "l'hôtellerie",
    desc: "Notre spécialisation exclusive dans l'hôtellerie nous permet d'anticiper vos besoins avant même qu'ils ne deviennent des problèmes. Chaque solution est calibrée pour les exigences d'un établissement 4 ou 5 étoiles.",
